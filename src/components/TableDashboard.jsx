  ...
  return (
    <div className="w-full mt-10 mb-10 rounded-2xl bg-white px-7 pb-7 relative z-0 shadow-md">
        <div className="bg-blue-600 rounded-2xl px-5 py-3 flex items-center justify-between relative -top-6 shadow-sm">
            <h1 className="text-white text-xl font-medium">Our Project</h1>
            ...
            <table className="items-center w-full border-collapse">
                <thead>
                    <tr>
                        ...
                        <th className="px-2 text-teal-500 align-middle border-b border-solid border-gray-200 py-3 text-sm whitespace-nowrap font-light text-center">Progress</th>
