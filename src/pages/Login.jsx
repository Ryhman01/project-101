        ...
        <div className="bg-white rounded-2xl p-5 w-full">
          ...
          <form action="" className="mt-10 flex flex-col gap-y-5">
            <div className="flex flex-col">
              ...
              <input type="text" placeholder="Type here . . ." className="w-full py-2 px-4 border border-blue-500 text-sm rounded-full outline-none"/>
            </div>
            <div className="flex flex-col">
            ...
            <Link to={'/dashboard'}><button className="w-full py-2 bg-blue-500 text-white font-medium rounded-full">Login</button></Link>
            <Link to={'/forgotpassword'}><p className="text-center font-medium text-blue-500">Forgot password?</p></Link>
          </form>
        </div>
      </div>
      <div className="w-full md:w-1/2 h-screen bg-blue-500 flex justify-center items-center py-10">
        <div className="backdrop-blur-sm bg-white/30 shadow-sm text-white rounded-2xl relative flex flex-col h-full w-2/3">
          <p className="text-2xl font-semibold mt-16 mx-10">
            Very good works are working for you.
          </p>
          <p className="text-2xl font-semibold mx-10">Login Now</p>
          <img
            src={Image}
            alt="image"
            className="h-full w-auto object-cover self-center"
          />
